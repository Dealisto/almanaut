...
var EntityTypes = []string{"host", "service", "network", "domain", "certificate", "backup", "hardware", "subscription", "account", "site", "location", "rack", "contact", "vlan", "reservation", "nic", "port"}

// RelationshipKinds is the closed set of relationship labels ("from <kind> to").
var RelationshipKinds = []string{"runs on", "connected to", "exposed via", "secured by", "backed up by", "depends on", "administered by", "owned by"}
...
type Relationship struct {
	...
	FromType string `yaml:"from_type" json:"from_type"`
	FromID   int64  `yaml:"from_id" json:"from_id"`
	ToType   string `yaml:"to_type" json:"to_type"`
	ToID     int64  `yaml:"to_id" json:"to_id"`
