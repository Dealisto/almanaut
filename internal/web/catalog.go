...
// entityCatalog aggregates the seven entity repositories so the relationship UI
...
// options returns every entity across all seven types as selectable options.
